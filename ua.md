...
- **фото документа** (камера або галерея);
- **текст витрат** (вставка, веб-сторінка за URL, QR/штрихкод);
...
Вміст документа (зображення або текст) **не зберігається в нашій базі даних**. Ми **не ведемо журнал** розпізнавання. Обробка на стороні OpenAI регулюється [їхньою політикою конфіденційності](https://openai.com/policies/privacy-policy).
...
- ми отримуємо інформацію про статус підписки/покупки через **RevenueCat** (ідентифікатор користувача, продукт, термін дії, баланс AI Tokens).
...
- розпізнавання витрат за вашим запитом;
- формування звітів із перерахунком сум у обрану валюту (курси валют);
- надання платних функцій (підписка, AI Tokens);
- експорт даних;
...
| **OpenAI** | розпізнавання витрат (за вашою дією) | [openai.com/policies/privacy-policy](https://openai.com/policies/privacy-policy) |
